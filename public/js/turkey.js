   ...
   $('#turkey').on('click', function(event){
    $.ajax({
      ...
      dataType: 'json'
        ...
        var releasesTitle = '<h2>New Releases in Turkey</h2>';
    ...
    $.ajax({
      ...
      $('#categoriesContainer').on('click', 'p', function() {
        ...
        $.ajax({
          ...
          $('#categoriesPlaylists').append($anchorplaylistNameOne);
          var uriOne = results.body.playlists.items[1].uri;
          $('#categoriesPlaylists').append('<iframe src="https://embed.spotify.com/?uri=' + uriOne + '" width="300" height="380" frameborder="0" allowtransparency="true"></iframe>'); 
          ...
          $('#categoriesPlaylists').append($anchorplaylistNameTwo);
          var uriTwo = results.body.playlists.items[2].uri;
          $('#categoriesPlaylists').append('<iframe src="https://embed.spotify.com/?uri=' + uriTwo + '" width="300" height="380" frameborder="0" allowtransparency="true"></iframe>');
          ...
          $('#categoriesPlaylists').append($anchorplaylistNameThree);
          var uriThree = results.body.playlists.items[3].uri;
          $('#categoriesPlaylists').append('<iframe src="https://embed.spotify.com/?uri=' + uriThree + '" width="300" height="380" frameborder="0" allowtransparency="true"></iframe>'); 
          ...
          $('#categoriesPlaylists').append($anchorplaylistNameFour);
          var uriFour = results.body.playlists.items[4].uri;
          $('#categoriesPlaylists').append('<iframe src="https://embed.spotify.com/?uri=' + uriFour + '" width="300" height="380" frameborder="0" allowtransparency="true"></iframe>');
          ...
          $('#categoriesPlaylists').append($anchorplaylistNameFive);
          var uriFive = results.body.playlists.items[5].uri;
          $('#categoriesPlaylists').append('<iframe src="https://embed.spotify.com/?uri=' + uriFive + '" width="300" height="380" frameborder="0" allowtransparency="true"></iframe>');
        });
      });
      // getting heading to appear for categories
      var categoriesTitle = '<h2>Choose from one of the top Categories in Turkey to hear top Playlists</h2>';
      $('#headerCategories').html(categoriesTitle);

      // getting categories to turn up
